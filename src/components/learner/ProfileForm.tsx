      ...
      <div className="space-y-8 divide-y divide-gray-200">
        <div>
          ...
          <div className="mt-6 grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
            <div className="sm:col-span-6">
              ...
              <div className="mt-2 flex items-center space-x-5">
                ...
                <FileUpload
                  ...
                  config={{ acceptedTypes: ['image/*'], maxSize: 2 * 1024 * 1024 }}
                />
              </div>
            </div>
            ...
            <div className="sm:col-span-6">
              <FormField label="Bio" name="bio" hint="A brief summary of your professional background (max 160 characters).">
                <TextArea
                  name="bio"
                  value={formData.bio || ''}
            ...
            <div className="sm:col-span-6">
              <FormField label="Introduction" name="introduction" hint="Introduce yourself to mentors. Mention what you're working on and what you hope to achieve.">
                <TextArea
                  name="introduction"
        ...
        <div className="pt-8">
          ...
          <div className="mt-6 grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
            <div className="sm:col-span-6">
              <FormField name="learningGoals" label="Learning Goals" hint="Tags that represent your primary learning objectives.">
                <LearningGoals
            ...
            <div className="sm:col-span-6">
              <FormField name="skillLevels" label="Skill Levels" hint="Your current proficiency in relevant technical areas.">
            ...
            <div className="sm:col-span-3">
              <FormField label="Preferred Learning Style" name="preferredLearningStyle">
                <Select
                  ...
                  onChange={(e) => handleChange('preferredLearningStyle', e)}
